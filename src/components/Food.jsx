...
const Food = () => {
    ...
    return (
        <div className="mx-auto  px-6 py-12 max-w-[1640px]">
            <h1 className="text-orange-600 font-bold text-center text-3xl md:text-4xl ">Top Rated Menu Items </h1>
            <div className="flex flex-col lg:flex-row justify-between gap-1 mt-4">
                <div className="">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 pt-4">
                {foods.map((item, index) => (
                    <div key={index}  className="border shadow-lg hover:scale-105 duration-300 rounded-lg">
                        ...
                        <div className="flex justify-between items-center gap-1 px-2 py-4">
                            <p className="font-bold  text-xs md:text-lg">{item.name}</p>
                            <p>
                                <span className="bg-orange-500 text-white p-1 rounded-full text-xs md:text-lg">{item.price }</span>
                            </p>
                        </div>
                </div>
